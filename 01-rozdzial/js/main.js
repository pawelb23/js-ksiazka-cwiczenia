...
while (liczba >= 0) {
    ...
    liczba--;  //aby wszystko było w dobrze tutaj musi być znak zmniejszania lub zwiększania wartości podanych w założeniach funkcji
...
while (liczba > 0) {
    ...
    document.write("Wartość " + '<b>' + liczba + '</b>' + " jest większa od zera!<br>"); // taki zapis --- '<b>' + liczba + '</b>' --- pozwala pogrubić naszą zmienną (czyli var liczba) UWAGA - nie działa w funkcji alert i prompt (console.log - chyba też nie --- warto jeszcze sprawdzić)
...
for (var i = 0; count >= i; count--) {
    ...
    } else if (count == 95) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 85) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 75) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 65) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 55) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 45) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 35) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
    ...
    } else if (count == 25) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
        ...
        console.log('Jedną weź i podaj w koło.');
        console.log(count - 1 + ' ' + word + ' jeszcze zostanie!');
    } else if (count == 5) //ze znakiem = (równa się) nie działa musi tu być znak == (przyrównania)
    {
        console.log(count + ' ' + word + ' piwa na ścianie.');
        console.log(count + ' ' + word + ' piwa.');
        console.log('Jedną weź i podaj w koło.');
