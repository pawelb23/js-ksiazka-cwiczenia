...
var speakTwo = dog.name + " szczeka " + dog.bark + " kiedy ma ochotę na " + dog.activity;
...
document.write("<b>" + carToSell.make + "</b>" + "<br>" + carToSell.model + "<br>" + carToSell.year + "<br>" + carToSell.color + "<br>" + carToSell.passengers + "<br>" + carToSell.convertible + "<br>" + carToSell.mileage + "<br>" + "<br");
...
function displayCar(vehicle) {
    ...
    console.log("Twoim nowym samochodem jest " + vehicle.make + " " + vehicle.model + " z roku " + vehicle.year);

    document.write("<br>" + "<br>" + "Poniżej - Drugi przykład, ale wychodzi to samo co wyżej." + "<br>" + "<br>" + "<b>" + vehicle.make + "</b>" + "<br>" + vehicle.model + "<br>" + vehicle.year + "<br>" + vehicle.color + "<br>" + vehicle.passengers + "<br>" + vehicle.convertible + "<br>" + vehicle.mileage + "<br>");
...
var fiat = {
    ...
    drive: function () {
        ...
        if (this.started) { //aby wszystko zadziałało poprawnie musimy tutaj użyć "this", aby program wiedział, że odnosimy się do tego konkretnego obiektu i właściwości zawartych w nim.
