...
console.log(ships[0].locations[1]); //Ważne w ten sposób dostaniemy się do pierwszego locations i do drugiego miejsca w tablicy (czyli do liczby 41). Należy pamiętać, że liczymy wartości od zera, czyli pierwsze locations ma numer 0, tak jak wartość w tablicy.
